...
namespace Persistence.Migrations
{
    ...
    [Migration("20210816041528_ChangedPracticalSizeToString")]
    partial class ChangedPracticalSizeToString
    {
            ...
            modelBuilder.Entity("Domain.Moisture.MoistureContent", b =>
                {
                    ...
                    b.Property<double>("MaterialWetMass")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Domain.Preparation", b =>
                {
                    ...
                    b.Property<string>("VisualNomialPraticalSize")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Preparation", b =>
                {
                    ...
                    b.HasOne("Domain.OvenEquipment", "Oven")
                        .WithMany()
